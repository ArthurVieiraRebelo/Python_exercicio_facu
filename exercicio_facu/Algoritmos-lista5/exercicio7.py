# 7.	Escrever a função que recebe por
# parâmetro uma string e um caracter. e a
# função deve retornar os primeiros caracteres
# da string até encontrar o caracter passado
# por parâmetro.
